...
export function setTenantId(tenantId: string): void {
  NativeMobileSdkReactNative.setTenantId(tenantId);
}

export function setTagServer(tagServer: string): void {
  NativeMobileSdkReactNative.setTagServer(tagServer);
}

export function setAppId(appId: string): void {
  NativeMobileSdkReactNative.setAppId(appId);
}

export function initializeCollection(): void {
  NativeMobileSdkReactNative.initializeCollection();
}

export function getSessionId(callback: (sessionId: string) => void): void {
...
export function shutDown(): void {
  NativeMobileSdkReactNative.shutDown();
}

export function resetDeviceID(): void{
  NativeMobileSdkReactNative.resetDeviceID();
}
...
export async function loadSpotData(
  ...
  try {
    ...
    return `Error loading spot data: ${e instanceof Error ? e.message : String(e)}`;;
  }
}
