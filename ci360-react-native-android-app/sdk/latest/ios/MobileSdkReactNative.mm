...
/*RCT_EXPORT_METHOD(registerDeviceToken: (NSString*)deviceTokenStr) {
    [SASCollector registerForMobileMessages:<#(NSData * _Nonnull)#> completionHandler:<#^(void)completionHandler#> failureHandler:<#^(void)failureHandler#>];
//    [UIApplication.sharedApplication didChangeValueForKey:@"deviceToken"];
