...
4. Example Code: [newPageExample.tsx](./docs/newPageExample.tsx)
...
5. Example Code: [addAppEventExample.tsx](./docs/addAppEventExample.tsx)
...
4. As a reference, working with the InlineAdView spot involves three components:
   ...
   - Bridging:
     - android/[java/views/InlineAdViewManager.java](./docs/views/InlineAdViewManager.java)
     - android/[java/views/InlineAdView.java](./docs/views/InlineAdView.java)
     - android/[java/views/Constants.java](./docs/views/Constants.java)
   - UIManager:
     - src/[/views/InlineAdView.tsx](./docs/views/InlineAdView.tsx)

5. Example Code: [addInlineAdViewExample.tsx](./docs/addInlineAdViewExample.tsx)
...
4. As a reference, working with the InterstitialAdView spot involves three components:
   ...
   - Bridging:
     - android/[views/InterstitialAdViewManager.java](./docs/views/InterstitialAdViewManager.java)
     - android/[views/InterstitialAdView.java](./docs/views/InterstitialAdView.java)
   - Managing events:
     - android/[Constants.java](./docs/Constants.java)
   - UIManager:
     - src/[views/InterstitialAdView.tsx](./docs/views/InterstitialAdView.tsx)

5. Example Code: [addInterstitialAdViewExample.tsx](./docs/addInterstitialAdViewExample.tsx)
